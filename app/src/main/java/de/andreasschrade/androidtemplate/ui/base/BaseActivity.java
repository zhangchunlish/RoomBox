...
import de.andreasschrade.androidtemplate.ui.quote.RoomRegistActivity;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private void setupNavDrawer() {
        ...
        if (navigationView != null) {
            hideOrShowUserNav(navigationView);
    ...
    private void hideOrShowUserNav(NavigationView navigationView){
        MenuItem userNav= navigationView.getMenu().getItem(2);
        if(userNav==null) return;
        if(Constants.BOXADMIN.equals(GlobalParams.USERNAME)){
    ...
    private void goToNavDrawerItem(int item) {
        switch (item) {
            ...
            case R.id.nav_samples:
                ...
                break;
            case R.id.nav_user:
                startActivity(new Intent(this, de.andreasschrade.androidtemplate.ui.user.ListActivity.class));
                break;
